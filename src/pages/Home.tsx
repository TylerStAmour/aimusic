    ...
    return (
        <div>
                ...
                <div className={"flex flex-col grow space-between"}>
                    ...
                    <div className={"flex flex-row justify-center items-end grow text-white"}>
                        <div className={"flex grow flex-col"}>
                            <div className={"flex justify-center items-end bg-gradient-to-b from-neutral-900 to-dark h-24"}>
            ...
            <div className={"relative z-10"}>
                ...
                <p className={"bg-neutral-900 text-white text-3xl pt-12 flex justify-center"}>
                    Les Réseaux Neuronales
                </p>
                <div className={"grid grid-cols-2 gap-10 bg-neutral-900 pt-20 pl-20 pr-20 pb-24"}>
                    <div ref={viewMoreRef}>
                    ...
                    <div className={"flex h-52 self-center justify-self-center bg-neutral-800 rounded-lg"}>
